...
exports.MachineModule = MachineModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: machine_schema_1.Machine.name, schema: machine_schema_1.MachineSchema }]),
        ],
        providers: [machine_service_1.MachineService],
        controllers: [machine_controller_1.MachineController],
        exports: [mongoose_1.MongooseModule, machine_service_1.MachineService],
    })
], MachineModule);
