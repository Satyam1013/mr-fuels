...
exports.ProductDetailsModule = ProductDetailsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: product_details_schema_1.ProductDetails.name,
                    schema: product_details_schema_1.ProductDetailsSchema,
                },
